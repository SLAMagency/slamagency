...
function ak_admin_scripts() {
	wp_enqueue_script( 'ak_admin_js', get_template_directory_uri() . '/library/js/admin.js' );
}

add_action( 'admin_enqueue_scripts', 'ak_admin_scripts' );


// Custom Backend Footer
function joints_custom_admin_footer() {
	_e('<span id="footer-thankyou">Developed by <a href="http://artspeakdesign.com" target="_blank">ArtSpeak Design</a></span>.', 'jointstheme');
}
