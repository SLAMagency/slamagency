...
<?php if ( have_comments() ) : ?>
	<h5 id="comments" class="h5"><?php comments_number(__('<span>No</span> Responses', 'jointstheme'), __('<span>One</span> Response', 'jointstheme'), _n('<span>%</span> Response', '<span>%</span> Responses', get_comments_number(),'jointstheme') );?> to &#8220;<?php the_title(); ?>&#8221;</h5>
...
<section id="respond" class="respond-form">
	...
	<h5 id="comment-form-title" class="h5"><?php comment_form_title( __('Leave a Reply', 'jointstheme'), __('Leave a Reply to %s', 'jointstheme' )); ?></h5>
