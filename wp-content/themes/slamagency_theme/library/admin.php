...
function slam_admin_scripts() {
	wp_enqueue_script( 'slam_admin_js', get_template_directory_uri() . '/library/js/min/admin-min.js' );
}

add_action( 'admin_enqueue_scripts', 'slam_admin_scripts' );

// Custom Backend Footer
function joints_custom_admin_footer() {
	_e('<span id="footer-thankyou">Developed by <a href="http://slamagency.com" target="_blank">Slam Agency</a></span>.', 'jointstheme');
}
